    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', 'EmailField', blank=True, max_length=254, verbose_name='email address')),
                ...
                ('role', 'CharField', choices=[('admin', 'Admin'), ('salesman', 'Salesman')], default='salesman', max_length=10)),
                ('business_assigned', 'CharField', blank=True, choices=[('mpesa', 'M-Pesa'), ('salon', 'Salon'), ('hotspot', 'Hotspot')], max_length=10, null=True)),
                ('groups', 'ManyToManyField', blank=True, help_text='The groups this user belongs to.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
